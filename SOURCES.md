This tree is a copy of `persianray-ios/ios-awg-xray` for HarmonyOS NEXT.
Do not edit the iOS library. Recopy from iOS when that engine changes, then keep `MobileLibrary/OHOS/`.
